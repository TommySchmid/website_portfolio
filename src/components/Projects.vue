<template>
    <div className="projectsContainer" id="projects">
      <h1>PROJECTS</h1>
      <h4>Here you will find links to various projects that I have contributed to and created, and a bit of the inspiration and information behind each of them.</h4>
      <div className="projectsSubContainer"> 
        ...
        <a href="https://github.com/TommySchmid/music_viewer" target="_blank">Crate Companion v1</a>
        <div>
        ...
        <a href="https://github.com/TommySchmid/Ultimate-Music-List" target="_blank">Ultimate Music List</a>
        <div>
          ...
          <div>
            <img src="../assets/uml.png" style="width:50%;" />
          </div>
        </div>
        <a href="https://codepen.io/TommySchmid4954" target="_blank">Miscellaneous Apps</a>
        <div>
